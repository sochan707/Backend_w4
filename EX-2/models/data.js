...
// =================== get the whole data =======================
export const getJournalists = () => journalists;
export const getCategories = () => categories;
export const getArticles = () => articles;

// ===================== get data by id ========================
export const getJournalistById = (id) => journalists.find(j => j.id === id);
export const getCategoriesById = (id) => categories.find(c => c.id === id);
export const getArticlesById = (id) => articles.find(a => a.id === id);

// ===================== create function ========================
export const createJournalist = (name, email) => {
...
export const createArticle = (title, content, journalistId, categoryId) => {
    ...
    if (!journalistExists) throw new Error('Journalist not found');
